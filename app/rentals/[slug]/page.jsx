...
5. DAMAGE & LOSS
The renter is financially responsible for all damage to the vessel, motor, trailer, and associated equipment caused by negligence, misuse, or failure to follow applicable laws or these terms. This includes, but is not limited to: grounding, collision, swamping, fire caused by renter actions, and theft of accessories. Normal wear and tear is excluded. Damage will be assessed by repair invoices from a licensed marine repair facility.

6. RETURN CONDITIONS
The vessel must be returned to the designated launch point in clean condition, with all provided equipment (cooler, PFDs, anchor, etc.) on board. Fuel is included — the vessel must not be refueled by the renter. The vessel must be returned by the agreed-upon end time. Late returns will be charged at $100/hour or partial hour beyond the rental period.
...
8. GOVERNING LAW
This agreement shall be governed by the laws of the State of New York. Any disputes shall be resolved in the courts of Essex County, New York.
...
11. INDEMNIFICATION
I agree to INDEMNIFY AND HOLD HARMLESS the Released Parties from any loss, liability, damage, cost, or expense that they may incur as a result of any claim made by me, my passengers, or any third party arising from my rental or operation of the vessel.
...
13. ACKNOWLEDGMENT
I acknowledge that I have read this agreement in its entirety, that I understand its terms, that I am signing it freely and voluntarily, and that I intend it to be a complete and unconditional release of all liability to the greatest extent allowed by law. I further acknowledge that no oral representations, statements, or inducements have been made apart from what is written here.`;
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {[
                  ...
                  [termsRead,     setTermsRead,      "I have read the full Terms & Conditions and Liability Waiver above and agree to be bound by them."],
        ...
        <div style={{ padding: "32px 0", borderBottom: `1px solid ${T.wire}` }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {[
              ...
              ["Weather", "Severe weather (lightning, winds 20+ mph, USCG advisory) — full refund or reschedule. Minor weather is not a valid cancellation reason."],
              ["Late return", "$100/hour or partial hour past agreed return time."],
              ["Damage", "Renter is responsible for all damage caused by negligence or misuse, assessed by licensed marine repair invoices."],
              ["Liability", "A signed liability waiver is required before payment is processed. The waiver is legally binding."],
            ].map(([heading, text]) => (
