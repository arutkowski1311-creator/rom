...
function SignupForm({ role, onSwitch }) {
  ...
  return (
    <div>
      ...
      <Field label="Referral Code (optional)" value={referralCode} onChange={setReferralCode} placeholder="e.g. ROM-JAMES4821" onKeyDown={e=>e.key==="Enter"&&submit()}/>
...
export default function AuthPage({ defaultMode = "signup-traveler" }) {
